...
<div id="content-left">
            ...
            <div id="content-right">
                <div class="path">LIST Canceled ORDERS</b></div>
                                ...
                                <div class="profile-order-title-right">
                                    <c:choose>
                                        <c:when test="${o.getRequiredDate()!=null && o.getShippedDate()==null}">
                                            <span style="color: blue;">Pending</span><a href="<%=path%>/account/profile1?idCancel=${o.getOrderID()}" style="color: red;">|Cancel</a>
                                        </c:when>
                                        <c:when test="${o.getRequiredDate()!=null && o.getShippedDate()!=null}">
